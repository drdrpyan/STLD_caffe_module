...
#include "softmax_focal_loss_layer.hpp"
...
void SoftmaxFocalLossLayer<Dtype>::LayerSetUp(
...
template <typename Dtype>
void SoftmaxFocalLossLayer<Dtype>::Reshape(
    const vector<Blob<Dtype>*>& bottom, const vector<Blob<Dtype>*>& top) 
{
...
template <typename Dtype>
Dtype SoftmaxFocalLossLayer<Dtype>::get_normalizer(
...
template <typename Dtype>
void SoftmaxFocalLossLayer<Dtype>::compute_intermediate_values_of_cpu() {
...
template <typename Dtype>
void SoftmaxFocalLossLayer<Dtype>::Forward_cpu(
    const vector<Blob<Dtype>*>& bottom, const vector<Blob<Dtype>*>& top) 
{
...
template <typename Dtype>
void SoftmaxFocalLossLayer<Dtype>::Backward_cpu(const vector<Blob<Dtype>*>& top,
...
INSTANTIATE_CLASS(SoftmaxFocalLossLayer);
REGISTER_LAYER_CLASS(SoftmaxFocalLoss);
