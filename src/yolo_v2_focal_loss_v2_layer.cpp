#include "yolo_v2_focal_loss_v2_layer.hpp"
...
void YOLOV2FocalLossV2Layer<Dtype>::LayerSetUp(
...
template <typename Dtype>
void YOLOV2FocalLossV2Layer<Dtype>::Reshape(
...
template <typename Dtype>
void YOLOV2FocalLossV2Layer<Dtype>::Forward_cpu(
    const vector<Blob<Dtype>*>& bottom, const vector<Blob<Dtype>*>& top) {
...
template <typename Dtype>
void YOLOV2FocalLossV2Layer<Dtype>::Clear() {
  noobj_loss_ = 0;
  obj_loss_ = 0;
  cls_loss_ = 0;
  coord_loss_ = 0;
...
template <typename Dtype>
void YOLOV2FocalLossV2Layer<Dtype>::ShiftAnchors(
...
template <typename Dtype>
void YOLOV2FocalLossV2Layer<Dtype>::FindBestMatching(
...
template <typename Dtype>
cv::Rect_<Dtype> YOLOV2FocalLossV2Layer<Dtype>::RawBBoxToAnchorBBox(
...
template <typename Dtype>
void YOLOV2FocalLossV2Layer<Dtype>::ForwardNegative(
...
template <typename Dtype>
void YOLOV2FocalLossV2Layer<Dtype>::ForwardPositive(
    const Blob<Dtype>& input, int n, int h, int w, int anchor,
...
template <typename Dtype>
void YOLOV2FocalLossV2Layer<Dtype>::ForwardConf(
  ...
  Dtype current_loss = scale * focal_loss_alpha_ * std::pow(sub, focal_loss_gamma_);
  loss += std::abs(current_loss);

  Dtype entrophy_diff = focal_loss_alpha_ * focal_loss_gamma_ * std::pow(sub, focal_loss_gamma_ - 1);
...
template <typename Dtype>
void YOLOV2FocalLossV2Layer<Dtype>::ForwardBBox(
    const Blob<Dtype>& input, int n, int h, int w, int anchor,
...
template <typename Dtype>
void YOLOV2FocalLossV2Layer<Dtype>::ForwardClass(
...
template <typename Dtype>
void YOLOV2FocalLossV2Layer<Dtype>::Backward_cpu(
    const vector<Blob<Dtype>*>& top, 
...
template <typename Dtype>
cv::Point YOLOV2FocalLossV2Layer<Dtype>::GetCellTopLeft(int row, int col) const {
  CHECK_GE(row, 0);
...
template <typename Dtype>
Dtype YOLOV2FocalLossV2Layer<Dtype>::CalcIoU(
...
template <typename Dtype>
Dtype YOLOV2FocalLossV2Layer<Dtype>::CalcOverlap(
...
template <typename Dtype>
cv::Rect_<Dtype> YOLOV2FocalLossV2Layer<Dtype>::GetPredBBox(
...
template <typename Dtype>
cv::Rect_<Dtype> YOLOV2FocalLossV2Layer<Dtype>::RawBoxToYOLOBox(
...
template <typename Dtype>
cv::Rect_<Dtype> YOLOV2FocalLossV2Layer<Dtype>::YOLOBoxToRawBox(
...
#ifdef CPU_ONLY
STUB_GPU(YOLOV2FocalLossV2Layer);
#endif

INSTANTIATE_CLASS(YOLOV2FocalLossV2Layer);
REGISTER_LAYER_CLASS(YOLOV2FocalLossV2);
