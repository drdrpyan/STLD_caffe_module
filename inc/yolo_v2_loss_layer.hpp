#ifndef TLR_YOLO_V2_LOSS_LAYER_HPP_
#define TLR_YOLO_V2_LOSS_LAYER_HPP_
...
// inline functions
template <typename Dtype>
inline YOLOV2LossLayer<Dtype>::YOLOV2LossLayer(const LayerParameter& param) 
  : LossLayer<Dtype>(param) {

}

template <typename Dtype>
inline const char* YOLOV2LossLayer<Dtype>::type() const {
  return "YOLOV2Loss";
}

template <typename Dtype>
inline int YOLOV2LossLayer<Dtype>::ExactNumBottomBlobs() const {
  return 3;
}

template <typename Dtype>
inline int YOLOV2LossLayer<Dtype>::ExactNumTopBlobs() const {
  return -1;
}

template <typename Dtype>
inline int YOLOV2LossLayer<Dtype>::MinTopBlobs() const {
  return 1;
}

template <typename Dtype>
inline int YOLOV2LossLayer<Dtype>::MaxTopBlobs() const {
  return 13;
}


template <typename Dtype>
inline int YOLOV2LossLayer<Dtype>::GetAnchorChannel(
...
template <typename Dtype>
inline int YOLOV2LossLayer<Dtype>::GetClassChannel(
...
template <typename Dtype>
inline Dtype YOLOV2LossLayer<Dtype>::Sigmoid(Dtype value) const {
  return 1. / (1. + std::exp(-value));
}

} // namespace caffe

#endif // !TLR_YOLO_V2_LOSS_LAYER_HPP_